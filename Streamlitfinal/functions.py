...
# def pretty_print_message(message, indent=False):
#     """Pretty print a single message dictionary or object."""
#     if hasattr(message, "pretty_repr"):
#         pretty_message = message.pretty_repr(html=True)
#     else:
#         # Fallback for dict or other types
#         pretty_message = pprint(message, indent=2, width=120, compact=False)
#         return
...
#     """Pretty print the 'messages' list from the response dict."""
...
#         else:
#             pprint(msg, indent=2, width=120, compact=False)
#         print("\n")